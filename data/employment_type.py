...
class EmploymentType:
  ...
  def as_list(self):
    ...
    return [str(self.label), str(self.weekly_hours), str(self.monthly_hours), str(self.has_overtime)]
    ...
    try:
      if self.label == other.label:
        if self.weekly_hours == other.weekly_hours:
          if self.monthly_hours == other.monthly_hours:
            return cmp (self.has_overtime, other.has_overtime)
          else:
            return cmp(self.monthly_hours, other.monthly_hours)
        else:
