...
class MainWindow(wx.Frame):
  ...
  def __init__(self,
    ...
    notebook.AddPage(get_panels.get_scheduling_unit_panel (scheduling_units, notebook), "Delovišča - vloge")
    notebook.AddPage(get_panels.get_workplace_panel (workplaces, notebook), "Delovišča")
